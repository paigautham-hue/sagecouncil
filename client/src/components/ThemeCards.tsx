...
import { LotusIcon, CompassIcon, LabyrinthIcon, SeedIcon, SacredGeometryIcon, InfinityIcon, HeartMandalaIcon, HourglassIcon, PhoenixIcon, EnsoIcon } from "@/components/icons/SophisticatedIcons";
